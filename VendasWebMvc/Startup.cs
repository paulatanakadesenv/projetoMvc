...
namespace VendasWebMvc
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ServicoRegistroVendas>();
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ServicoSeeding servicoSeeding)
        {
            ...
            var opcaosLocalizacao = new RequestLocalizationOptions
            {
            ...
            app.UseRequestLocalization(opcaosLocalizacao);

            if (env.IsDevelopment())
            {
                app.UseDeveloperExceptionPage();
                servicoSeeding.PopularBaseDados();
            }
            else
            {
